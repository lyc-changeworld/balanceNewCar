...
void cal_offset(void)
{
  ...
  if(AD_result[0]+AD_result[2] > 120  )
  {
...
//  if(straightTime > 20&&AD_result[1]>40 && AD_result[1]>AD_result[0] && AD_result[1]>AD_result[2])
//  {
//    offsetTemp = first_offset[0];
//  }
//  
