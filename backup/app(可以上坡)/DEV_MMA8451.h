...
/********用户可修改值 开始***********/
//连接MMA8451用到的I2C通道
#define MMA8451_I2CX    (I2C1)

//连接MMA8451用到的SCL引脚
#define MMA8451_SCLPIN  (PTE1)

//连接MMA8451用到的SDA引脚
#define MMA8451_SDAPIN  (PTE0)
/********用户可修改值 结束***********/
...
//=========MMA8451 功能参数==================//
#define MMA8451_DEV_ADDR   0x1C//Normally,can range 0x08 to 0xEF//原为0x1D(错的)
...
int16  LPLD_MMA8451_GetResult(uint8, uint8);//int16
