///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.20.2.7424/W32 for ARM       15/Aug/2016  15:07:18
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  E:\LPLD_OSKinetis_V3.1\lib\CPU\system_MK60.c
//    Command line =  
//        E:\LPLD_OSKinetis_V3.1\lib\CPU\system_MK60.c -D LPLD_K60 -D
//        USE_K60D10 -lCN
...
//        ARM_MATH_CM4
//    List file    =  
//        E:\LPLD_OSKinetis_V3.1\project\balanceNewCar\iar\FLASH\List\system_MK60.s
//
///////////////////////////////////////////////////////////////////////////////
...
// E:\LPLD_OSKinetis_V3.1\lib\CPU\system_MK60.c
//    1 /**
...
//   94   term_port_structure.UART_Uartx = TERM_PORT;
        LDR.W    R0,??DataTable6_9  ;; 0x4006d000
        STR      R0,[SP, #+12]
...
//  275     switch((SIM->FCFG1 & SIM_FCFG1_PFSIZE(0xF))>>SIM_FCFG1_PFSIZE_SHIFT)
        LDR.W    R0,??DataTable6_46  ;; 0x4004804c
        LDR      R0,[R0, #+0]
        LSRS     R0,R0,#+24
        ANDS     R0,R0,#0xF
        CMP      R0,#+7
...
??cpu_identify_27:
        LDR.W    R0,??DataTable6_51  ;; 0x40048050
        LDR      R0,[R0, #+0]
        LSLS     R0,R0,#+8
...
//  424   if (RCM->SRS1 & RCM_SRS1_SACKERR_MASK)
        LDR.N    R0,??DataTable6_78  ;; 0x4007f001
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
...
??Diagnostic_Reset_Source_5:
        LDR.N    R0,??DataTable6_85  ;; 0x4007f000
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+24
...
//  449     printf("[outSRS]SMC_PMPROT = %#02X ", (SMC->PMPROT))  ;
        LDR.N    R0,??DataTable6_92  ;; 0x4007e000
        LDRB     R1,[R0, #+0]
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        LDR.N    R0,??DataTable6_93
        BL       printf
//  450     printf("[outSRS]SMC_PMCTRL = %#02X ", (SMC->PMCTRL))  ;
        LDR.N    R0,??DataTable6_94  ;; 0x4007e001
        LDRB     R1,[R0, #+0]
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        LDR.N    R0,??DataTable6_95
        BL       printf
//  451     printf("[outSRS]SMC_VLLSCTRL = %#02X ", (SMC->VLLSCTRL))  ;
        LDR.N    R0,??DataTable6_96  ;; 0x4007e002
        LDRB     R1,[R0, #+0]
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        LDR.N    R0,??DataTable6_97
        BL       printf
//  452     printf("[outSRS]SMC_PMSTAT = %#02X \r\n", (SMC->PMSTAT))  ;
        LDR.N    R0,??DataTable6_98  ;; 0x4007e003
        LDRB     R1,[R0, #+0]
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        LDR.N    R0,??DataTable6_99
        BL       printf
//  453 
