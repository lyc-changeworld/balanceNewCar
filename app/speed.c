...
{ 
  ...
  if(runTime > 250)
  {
    nP=-angle_P*(angle-Angle_Zero+SA);//
  }else if(runTime > 150)
  {
    nP=-angle_P*(angle-Angle_Zero+17-(runTime-200)/50.0);
  }else if(runTime > 100)
  {
    nP=-angle_P*(angle-Angle_Zero+17);
  }else if(runTime > 80)
  {
    nP=-angle_P*(angle-Angle_Zero+(runTime-80)/1.17);
  }else if(runTime >40)
  {
...
extern int speedChangeTime;
extern uint8 speedChangeFlag;
